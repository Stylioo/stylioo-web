            ...
            <div className="my-auto mx-auto lg:ml-16 ">
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex flex-col gap-2">
                        ...
                        <input className="h-[36px]  w-[400px] rounded-lg border-gray-400" type="email" id="email" />
                    </div>
                    <div className="flex flex-col gap-2">
                        <label className="text-gray-700 font-[] text-[0.95rem]" htmlFor="password">Password</label>
                        <input className="h-[36px]  w-[400px] rounded-lg border-gray-400" type="password" id="password" />
                    </div>
