            ...
            <div className=" bg-white p-4">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex items-end">
                        {/* <button className="py-2 my-3 flex-grow text-sm transition duration-300 ease-in-out text-red-500 rounded-lg text-left ">{"Skip for now >"} </button> */}
                        <button className="py-2 my-3 flex-grow bg-red-700 hover:bg-red-600 hover:shadow transition duration-300 ease-in-out text-white rounded-lg ">Next</button>
                    </div>
                </div>
            </div>
        </div>
