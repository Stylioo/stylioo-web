    ...
    return (
        <div className="h-screen grid lg:grid-cols-2 select-none">
            ...
            <div className="my-auto mx-auto lg:ml-16 ">
                <div className="mb-8">
                    <h1 className="text-center lg:text-left text-3xl font-bold mb-2">Sign Up with us !</h1>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2 w-[350px] md:w-[400px]">
                        <label className="text-gray-600 font-[500] text-[0.9rem]" htmlFor="confirmPassword">Confirm Password</label>
                        <div className="flex">
                            <input className="h-10 border-gray-400 grow border-r-0 rounded-l-lg focus:ring-0 active:right-0" type={isShowPassword ? "text" : "password"} id="confirmPassword" />
                            <button
                                className='h-10 w-10  flex justify-center items-center border border-l-0 border-gray-400 rounded-r-lg'
                                onClick={() => setIsShowPassword(!isShowPassword)}
                            >
                    ...
                    <button className="py-3 my-4 bg-red-700 hover:bg-red-600 hover:shadow transition duration-300 ease-in-out text-white font-semibold rounded-lg ">Sign Up</button>
                </div>
